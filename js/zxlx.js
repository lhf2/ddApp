    ...
    $.ajax({
        ...
        success : function(msg) {
            for(var i=0;i<msg.length;i++){
                msg[i].index=i;
                var html='<li class="subject-list"><a><span class="subject-left"></span><span class="subject-center"></span><span class="subject-right"></span></a></li>'
                $('.subject-box').html();
            ...
            $(document).on("click",".subject-list",function(){
                ...
                window.location.href='../index-topic/topic.html?chapterId='+msg[index].id+'&stype='+subjectType+'&vtype='+vehicleType+'&testtype=3'+'&specialName='+msg[index].specific_name+'';
            });
